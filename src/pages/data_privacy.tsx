  ...
  return (
    <>
      ...
      <div className="content clearfix">
        <FeaturedMedia title="Data privacy" />
      </div>
        ...
        <div className="row">
          <div className="column width-8 justify">
            ...
            <p>
              ...
              Personal data are all data with which you can be personally
              identified. Detailed information on the subject of data protection
              can be found in our data protection declaration listed below this
              text.
            </p>
            ...
            <p>
              ...
              &quot;Note on the responsible body&quot; in this data protection
              declaration.
            </p>
            <h4>How do we collect your data?</h4>
            <p>
              On the one hand, your data is collected when you communicate it to
              us. This can be, for example, data that you enter in a contact
              form. Other data are recorded automatically or with your consent
              when you visit the website by our IT systems. This is mainly
              technical data (e.g. internet browser, operating system or time of
              the page view). This data is collected automatically as soon as
              you enter this website.
            </p>
            <h4>What do we use your data for?</h4>
            <p>
              Some of the data is collected in order to ensure that the website
              is error-free. Other data can be used to analyze your user
              behavior.
            </p>
            <h4>What rights do you have with regard to your data?</h4>
            <p>
              You have the right to receive information about the origin,
              recipient and purpose of your stored personal data free of charge
              at any time. You also have the right to request the correction or
              deletion of this data. If you have given your consent to data
              processing, you can revoke this consent at any time for the
              future. You also have the right to request that the processing of
              your personal data be restricted under certain circumstances. You
              also have the right to lodge a complaint with the competent
              supervisory authority. You can contact us at any time if you have
              any further questions about data protection.
            </p>
            <h2>2. Hosting</h2>
            <h3>External hosting</h3>
            <p>
              This website is hosted by an external service provider (hoster).
              The personal data recorded on this website is stored on the
              host&apos;s servers. This can be v. a. be IP addresses, contact
              requests, meta and communication data, contract data, contact
              data, names, website access and other data generated via a
              website. The hoster is used for the purpose of fulfilling the
              ...
              Para . 1 lit.f GDPR). Our hoster will only process your data
              insofar as this is necessary to fulfill its performance
            ...
            <p>
              We have concluded an order processing contract (AVV) with the
              above-mentioned provider. This is a contract stipulated by data
              protection law, which ensures that it processes the personal data
              of our website visitors only in accordance with our instructions
            ...
            <p>
              ...
              and this data protection declaration. When you use this website,
              various personal data are collected. Personal data are data with
              which you can be personally identified. This data protection
              declaration explains which data we collect and what we use it for.
              It also explains how and for what purpose this is done. We would
            ...
            <p>
              ...
              <br />
              Poppenreuther Strasse 67
              <br />
              90419 N&uuml;rnberg
            </p>
            <p>
              Phone: +49 163 7827586
              <br />
              Email: tatiher.translator@hotmail.com
            </p>
            <p>
            ...
            <p>
              ...
              until the purpose for the data processing no longer applies. If
              you make a legitimate request for deletion or revoke your consent
              to data processing, your data will be deleted unless we have any
              other legally permissible reasons for storing your personal data
              (e.g. tax or commercial retention periods); in the latter case,
            ...
            <p>
              ...
              express consent. You can revoke your consent at any time. The
              legality of the data processing carried out before the revocation
              remains unaffected by the revocation. Right to object to the
              collection of data in special cases and to direct advertising
              (Art. 21 GDPR)
            </p>
            <p>
              IF THE DATA PROCESSING BASED ON ART. 6 ABS. 1 LIT. E OR F GDPR,
              YOU HAVE AT ANY TIME THE RIGHT TO OBJECT TO THE PROCESSING OF YOUR
              PERSONAL DATA FOR REASONS ARISING FROM YOUR SPECIAL SITUATION;
              THIS ALSO APPLIES TO PROFILING BASED ON THESE PROVISIONS. THE
              RELEVANT LEGAL BASIS ON WHICH PROCESSING IS BASED ON THIS PRIVACY
              POLICY. IF YOU OBJECT, WE WILL NO LONGER PROCESS YOUR AFFECTED
              PERSONAL DATA UNLESS WE CAN PROVIDE COMPULSORY REASONS FOR
              PROCESSING THAT OCCURS, EXECUTES OR EXECUTES YOUR INTEREST,
              OBSERVES THE RIGHTS OBJECTION ACCORDING TO ART. 21 PARA. 1 GDPR).
              ...
              THIS ALSO APPLIES TO PROFILING TO THE EXTENT IN CONNECTION WITH
              SUCH DIRECT ADVERTISING. IF YOU OBJECT, YOUR PERSONAL DATA WILL NO
              LONGER BE USED FOR THE PURPOSE OF DIRECT ADVERTISING (OBJECTION
            ...
            <p>
              ...
              appeal exists without prejudice to other administrative or
              judicial remedies.
            </p>
            ...
            <p>
              Within the framework of the applicable statutory provisions, you
              have the right to free information about your stored personal
              data, their origin and recipient and the purpose of the data
              processing and, if necessary, a right to correct or delete this
              data. You can contact us at any time if you have any further
              questions on the subject of personal data.
            </p>
            <h3>Right to restriction of processing</h3>
            <p>
              You have the right to request that the processing of your personal
              data be restricted. You can contact us at any time for this
              purpose. The right to restriction of processing exists in the
              following cases:
            </p>
            <ul>
              <li>
                ...
                test, you have the right to request that the processing of your
                personal data be restricted.
              </li>
              <li>
                If the processing of your personal data happened / happens
                unlawfully, you can request the restriction of the data
              ...
              <li>
                ...
                long as it is not yet clear whose interests prevail, you have
            ...
            <p>
              ...
              data - apart from their storage - may only be used with your
            ...
            <h3>Contact form</h3>
            <p>
              If you send us inquiries using the contact form, your details from
              ...
              basis of Article 6 (1) (b) GDPR, provided that your request is
              related to the performance of a contract or to carry out
              pre-contractual measures is required.
            </p>
            <p>
              In all other cases, the processing is based on our legitimate
              interest in the effective processing of the inquiries sent to us
              (Art. 6 Para. 1 lit. f GDPR) or on your consent (Art. 6 Para. 1
            ...
            <p>
              ...
              including all personal data derived from it (name, request) will
              be stored and processed by us for the purpose of processing your
            ...
            <p>
              ...
              contract or to carry out pre-contractual measures is required.{" "}
            </p>
            <p>
              In all other cases, the processing is based on our legitimate
              interest in the effective processing of the inquiries sent to us
            ...
            <p>
              ...
              until you request us to delete it, revoke your consent to storage
              or the purpose for data storage no longer applies (e.g. after your
            ...
            <h3>Google Web Fonts (local hosting)</h3>
            <p>
              This page uses so-called web fonts, which are provided by Google,
            ...
            <p>
              Telefon: +49 163 7827586
              <br />
              E-Mail: tatiher.translator@hotmail.com
            </p>
            <p>
